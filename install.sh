...
cp -r ./front/templates/table /usr/local/lib/python2.7/dist-packages/notebook/templates
cp -r ./front/static/table /usr/local/lib/python2.7/dist-packages/notebook/static
